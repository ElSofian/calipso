...
module.exports = {
    ...
    run: async(client, interaction, { successEmbed, errorEmbed }) => {
        ...
        if (invalidSpecialities.length > 0)
            return errorEmbed(`L'employé n'a pas les spécialités suivantes : **${invalidSpecialities.join(", ")}**.`);
        ...
        successEmbed(`Les spécialités **${specialities.join(", ")}** ont bien été retirées à ${employee}.`);
    }
};
